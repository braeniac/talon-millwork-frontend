...
const CustomPickerProject = ({ modalVisible, setModalVisable, title, DATA, setPID, setFunction }) => {
    return(
        <Modal
            animationType="slide"
            transparent={true}
                            ...
                            DATA.slice(0).reverse().map((d, i) => (
                                ...
                                >
                                    <View style={{ borderBottomWidth: 1}}>
                                        <Text style={styles.items}>{d.pname}</Text>
                                    </View>
                                </TouchableOpacity>
                            ))
                        }
...
export default CustomPickerProject;
